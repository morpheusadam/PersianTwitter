...
بعد یک خط خالی، و بعد متن اصلی: حدود ۲۰۰ تا ۲۵۰ کلمه فارسی در دو یا سه
پاراگراف.

متن اصلی باید *توضیح* بدهد، نه اینکه تیتر را بازنویسی کند. یعنی:
- چه اتفاقی افتاده و دقیقاً چه چیزی تازه است
- جزئیات فنی مهم: نام محصول، نسخه، عدد، شماره‌ی CVE، روش حمله، معماری
- چرا اهمیت دارد و برای چه کسی
- اگر متن زمینه یا واکنشی دارد، آن را هم بیاور
...
- اگر متن کوتاه بود و ۲۰۰ کلمه محتوا نداشت، کوتاه‌تر بنویس. کش دادن ممنوع.
